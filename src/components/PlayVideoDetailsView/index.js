...
import VideoCardDetailsRoute from '../VideoCardDetailsRoute'
...
class PlayVideoDetailsView extends Component {
  state = {
...
export default PlayVideoDetailsView
